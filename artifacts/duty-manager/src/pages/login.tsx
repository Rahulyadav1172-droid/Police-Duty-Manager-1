...
import { useAuth, FIXED_USERNAME } from "@/hooks/use-auth";
...
export default function LoginPage() {
  ...
  function handleResetPassword(e: React.FormEvent) {
    ...
    const result = changePassword(resetCurrent, resetNew);
    if (result.success) {
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-lg px-4 py-3">
              ...
              <span className="text-white font-semibold text-sm">{FIXED_USERNAME}</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold h-11 text-base shadow-lg shadow-blue-900/40"
